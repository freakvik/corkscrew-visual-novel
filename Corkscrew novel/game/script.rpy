...
label pub:
    ...
    bt "Что, уже прикончил все запасы?"
    ...
    if info:
        ...
        cork "Да меня эта.. кассирша попросила. Ну, знаешь, сама пролезть не может, поэтому меня попросила. Правда за это я всё равно ничего не получил, но было познавательно."
        bt "Ха-ха, это точно! Видела её, иначе как динозавром и не назовёшь. Но всё же, что там?"
        ...
        cork "Ого, видно, я не один такой разочарованный жизнью. А, вообще, что они сами-то говорили, все внезапно нашли пачку денег на дороге?"
