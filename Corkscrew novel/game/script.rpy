...
label generator:
    ...
    cork "И какого чёрта он вообще взорвался? Не выдержал нагрузки, бедный?"
    ...
    "Поверьте наслово, Штопор очень опытен в этом плане, глаз намётан."
    "Так вот, из вида окурков следует, что кто-то тут недавно был и что-то делал. Возможно жёг собак заживо."
    "К сожалению, вы не судмедэксперт и не можете собрать больше улик, чем пару окурков, которые, к тому же, уже и не докурить."
    "И эта шерсть ещё... Всё произошедшее здесь казалось странным и напрягало нервы, от такого и протрезветь можно."
    ...
    "Как оказалось, нейроны в голове отстутсвовали, как и диплом судмедэксперта, пришлось оставить всё это добро на месте и покинуть помещение."
